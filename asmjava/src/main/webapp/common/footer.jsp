...
<footer class="tm-bg-gray pt-5 pb-3 tm-text-gray tm-footer">
	<div class="container-fluid tm-container-small">
	 ...
	 <script src="<c:url value='templates/user/js/plugins.js' />">
	...
	$('#changPassBtn').click(function() {
	 	...
	 	$.ajax({
	 		...
	 		$('#messageChangPass').text('Your passwprd has beend changed successfully!');
	 	}).fail(function(error){
	 		$('#messageChangPass').text('Your password is not correct, try again');
	 	});
	});
</script>